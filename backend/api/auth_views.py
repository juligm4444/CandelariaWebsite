...
def register_view(request):
    """Registration endpoint — delegates validation and creation to RegisterSerializer."""
    ...
    try:
        ...
        team_name = member.team.name_en if member else 'N/A'
        log_team_leader_event('registration_success', email, team_name, client_ip,
...
def check_email_view(request):
    ...
    is_whitelisted = whitelist_role is not None or is_team_leader_whitelist
    ...
    return Response({
        ...
        'is_team_leader_whitelist': is_team_leader_whitelist,
